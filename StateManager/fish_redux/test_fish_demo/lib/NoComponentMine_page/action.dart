...
enum NoComponentMineAction { 
  updateBase,//更新基本信息
  updateJob,//更新工作信息
  onRefresh//更新事件
 }

class NoComponentMineActionCreator {

  static Action updateBaseAction(String avatar,String name,int age){
    print('updateBaseAction');
    return Action(
      NoComponentMineAction.updateBase,
  ...
  static Action updateJobAction(String company,String job,String detail){
    ...
    return Action(
      NoComponentMineAction.updateJob,
  ...
  static Action onRefreshAction() {
    ...
    return const Action(NoComponentMineAction.onRefresh);
  }
}
